package com.ilyaskeskin.yemektariflerisqlite
...
class TarifFragment : Fragment() {
    ...
    //Fragmentlarda buton gibi gorsel sec gibi fonksiyonların çalışması için önce alttaki fonksiyonu
    //ekleyip tanımlamamız gerekiyor yoksa aşağıda bulunan diğer fonksiyonlar görsellerle haberleşmiyor
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == 2 && resultCode == Activity.RESULT_OK && data != null) {
            ...
            secilenGorsel = data.data //Görselin olduğu yer


            //VERSİYON KONTROLÜ YAPTIĞIMIZ YER-FARKLI VERSİYONLAR İÇİN İKİ TÜRLÜ BİTMAP ÇEVİRİYORUZ
    ...
    fun kucukBitmapOlustur(kullanicininSectigiBitmap: Bitmap, maximumBoyut: Int): Bitmap {
        ...
        if (bitmapOrani > 1) {
            ...
            //görselimiz dikey
            height = maximumBoyut
            val kisalitmisWidth = height * bitmapOrani
            width = kisalitmisWidth.toInt()
        }
